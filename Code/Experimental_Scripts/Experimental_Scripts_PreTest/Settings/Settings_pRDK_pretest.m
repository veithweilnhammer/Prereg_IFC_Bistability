...
disambiguation = [1 1 1 1 1 1]; % levels of disambiguation
...
fixation_interval = 5; Results.fixation_interval = fixation_interval;
...
mon_width   = 35;  Results.Monitor.mon_width = mon_width; % horizontal dimension of viewable screen (cm)

v_dist      = 59.5;  Results.Monitor.v_dist = v_dist; % viewing distance (cm)
