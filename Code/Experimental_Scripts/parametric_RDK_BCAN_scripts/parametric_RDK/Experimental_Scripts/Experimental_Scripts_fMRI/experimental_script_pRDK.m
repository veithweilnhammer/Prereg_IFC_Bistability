...
root_dir = 'C:\Users\bcanguest\Documents\PsychToolbox Experiments\AG_STERZER\Veith\parametric_RDK\Experimental_Scripts\Experimental_Scripts_fMRI\'; % root directory for settings and results

BlueValue = '116' % Put in Blue Value from Heterochromatic flicker photometry
Results.BlueValue = BlueValue;

RedValue = '100' % Put in Blue Value from Heterochromatic flicker photometry
Results.RedValue = RedValue
...
if which_run == 0
    ...
    transition_probability = 0.15; % probability of transition at each overlap. NaN for ambiguous stimulation.
